...
<div id="cardPerfil" class="card h-100">
    <div id="cardSeccion" class="card-header">
        <div
    ...
    <div id="cardSeccion" class="card-body">
        <div class="container">
                ...
                <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1 ">
                    <div class="form-outline mb4">
                        ...
                        <input type="password" class="form-control form-control-lg"
                            placeholder="Ingrese su nueva contraseña" id="inPassNueva" name="inPassNueva" />
                    </div>
                    <div class="form-outline mb4">
                        <label class="form-label" for="inPassConfirm">Confirmar contraseña:</label>
                        <input type="password" class="form-control form-control-lg" placeholder="Confirmar contraseña"
                            id="inPassConfirm" name="inPassConfirm" />
                    </div>
                    <br>
                    <div class="form-outline mb4">
                        <label class="form-label" for="inPass">Contraseña actual:</label>
                        <input type="password" class="form-control form-control-lg"
                            placeholder="Ingrese su contraseña actual" id="inPass" name="inPass" />
                    </div>
                    <br>
